    ...
    sections: [
      {
        ...
        durationSec: 25,
        narration: `Paso 1: Instalar. npm install @pga-ai/core y tu adaptador LLM. Soportamos @pga-ai/adapters-llm-anthropic para Claude, @pga-ai/adapters-llm-openai para GPT-4, @pga-ai/adapters-llm-google para Gemini, @pga-ai/adapters-llm-ollama para modelos locales, y @pga-ai/adapters-llm-perplexity para búsqueda web. Paso 2: Inicializar. Crea una instancia PGA con tu LLM y adaptador de almacenamiento. Crea un genoma con nombre y prompt del sistema. Paso 3: Reemplaza tu llamada LLM con genome.chat(). Pasa el mensaje del usuario y un ID de usuario opcional. Eso es todo. Tu agente ahora evoluciona.`,
      },
      {
        title: "API Express",
        durationSec: 25,
